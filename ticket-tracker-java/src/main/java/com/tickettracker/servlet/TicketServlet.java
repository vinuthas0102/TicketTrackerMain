...
public class TicketServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                logger.error("Invalid UUID format in ticket creation request", e);
            ...
            logger.error("Unexpected error in POST /api/tickets", e);
    ...
    private void handleBulkCreate(HttpServletRequest request, HttpServletResponse response, User currentUser)
        ...
        logger.debug("Bulk created {} tickets", createdTickets.size());
