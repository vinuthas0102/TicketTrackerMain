...
public class WorkflowStepProgressDocumentDAO extends BaseDAO {
    ...
    public ProgressDocument findById(byte[] id, boolean includeContent) throws SQLException {
        ...
        try {
            ...
            if (rs.next()) {
                return mapResultSetToProgressDocument(rs, includeContent);
            }
            return null;
        } finally {
    ...
    private ProgressDocument mapResultSetToProgressDocument(ResultSet rs) throws SQLException {
        return mapResultSetToProgressDocument(rs, false);
    }

    private ProgressDocument mapResultSetToProgressDocument(ResultSet rs, boolean includeContent) throws SQLException {
