...
VALUES (
  ...
  'complaints',
  '{"categories": ["Service Quality", "Staff Behavior", "Facility Issues", "Process Issues", "Other"], "requestTypes": [{"label": "Pre-Occupation Maintenance", "value": "Pre-Occupation Maintenance", "requiresCEInspection": false}, {"label": "Vacation Handover", "value": "Vacation Handover", "requiresCEInspection": true}, {"label": "Annual Maintenance", "value": "Annual Maintenance", "requiresCEInspection": true}, {"label": "Emergency Maintenance", "value": "Emergency Maintenance", "requiresCEInspection": false}]}',
  1
);
...
VALUES (
  ...
  'grievances',
  '{"categories": ["Workplace Issues", "Policy Concerns", "Discrimination", "Safety Issues", "Other"], "requestTypes": [{"label": "Pre-Occupation Maintenance", "value": "Pre-Occupation Maintenance", "requiresCEInspection": false}, {"label": "Vacation Handover", "value": "Vacation Handover", "requiresCEInspection": true}, {"label": "Annual Maintenance", "value": "Annual Maintenance", "requiresCEInspection": true}, {"label": "Emergency Maintenance", "value": "Emergency Maintenance", "requiresCEInspection": false}]}',
  1
);
...
VALUES (
  ...
  'rti',
  '{"categories": ["Information Request", "Appeal", "Compliance", "Documentation", "Other"], "requestTypes": [{"label": "Pre-Occupation Maintenance", "value": "Pre-Occupation Maintenance", "requiresCEInspection": false}, {"label": "Vacation Handover", "value": "Vacation Handover", "requiresCEInspection": true}, {"label": "Annual Maintenance", "value": "Annual Maintenance", "requiresCEInspection": true}, {"label": "Emergency Maintenance", "value": "Emergency Maintenance", "requiresCEInspection": false}]}',
  1
);
...
VALUES (
  ...
  'pep',
  '{"categories": ["Planning", "Execution", "Monitoring", "Resource Management", "Quality Control"], "requestTypes": [{"label": "Pre-Occupation Maintenance", "value": "Pre-Occupation Maintenance", "requiresCEInspection": false}, {"label": "Vacation Handover", "value": "Vacation Handover", "requiresCEInspection": true}, {"label": "Annual Maintenance", "value": "Annual Maintenance", "requiresCEInspection": true}, {"label": "Emergency Maintenance", "value": "Emergency Maintenance", "requiresCEInspection": false}]}',
  1
);
...
-- Civil Manager (for C&E Inspections)
INSERT INTO users (id, name, email, role, department, password_hash, password_salt, active)
VALUES (
...
-- Electrical Manager (for C&E Inspections)
INSERT INTO users (id, name, email, role, department, password_hash, password_salt, active)
VALUES (
