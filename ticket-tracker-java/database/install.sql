...
-- Step 8: Add finance approval document columns
SELECT '==================================================================================' FROM DUAL;
SELECT 'STEP 7: Adding finance approval document columns...' FROM DUAL;
SELECT '==================================================================================' FROM DUAL;
@12-oracle-add-finance-approval-columns.sql
SELECT 'Finance approval columns added!' FROM DUAL;
SELECT '' FROM DUAL;

-- Step 9: Add step_type and request_type columns
SELECT '==================================================================================' FROM DUAL;
SELECT 'STEP 8: Adding step_type and request_type columns...' FROM DUAL;
SELECT '==================================================================================' FROM DUAL;
@13-oracle-add-step-type-and-request-type.sql
SELECT 'step_type and request_type columns added!' FROM DUAL;
SELECT '' FROM DUAL;

-- Step 10: Add username and last_login columns to users table
SELECT '==================================================================================' FROM DUAL;
SELECT 'STEP 9: Adding username and last_login columns to users...' FROM DUAL;
SELECT '==================================================================================' FROM DUAL;
@14-oracle-add-user-username-and-last-login.sql
SELECT 'username and last_login columns added!' FROM DUAL;
SELECT '' FROM DUAL;

-- Step 11: Add requestTypes to module configurations and C&E inspection users
SELECT '==================================================================================' FROM DUAL;
SELECT 'STEP 10: Adding requestTypes to modules and C&E inspection users...' FROM DUAL;
SELECT '==================================================================================' FROM DUAL;
